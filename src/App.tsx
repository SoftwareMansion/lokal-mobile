      ...
      <View style={styles.container}>
        ...
        <View style={styles.topBar}>
          <View style={styles.topBarMessage}>
            <Text style={styles.topBarTitleText}>{APP_TITLE}</Text>
          </View>
        ...
        <View style={styles.headerContainer}>
          <Text style={styles.headerContainerText}>Witaj, Somsiedzie!</Text>
        </View>
        ...
        <View style={styles.tileContainerRow}>
          <View style={[styles.tileElement, styles.tileElementNormal, styles.tileElementEvents]}>
            <Text style={[styles.tileElementCaptionText, styles.eventsText]}>WYDARZENIA</Text>
          </View>
